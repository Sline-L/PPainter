/****************************************************************************
** Meta object code from reading C++ file 'protocol_handler.h'
**
...
#include "../../../src/network/protocol_handler.h"
...
#error "The header file 'protocol_handler.h' doesn't include <QObject>."
...
template <> constexpr inline auto ProtocolHandler::qt_create_metaobjectdata<qt_meta_tag_ZN15ProtocolHandlerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'drawing_data_received'
        QtMocHelpers::SignalData<void(int, int, const QColor &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 3 }, { QMetaType::Int, 4 }, { QMetaType::QColor, 5 },
        }}),
    };
...
void ProtocolHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->drawing_data_received((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QColor>>(_a[3]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ProtocolHandler::*)(int , int , const QColor & )>(_a, &ProtocolHandler::drawing_data_received, 0))
            return;
    }
}
...
// SIGNAL 0
void ProtocolHandler::drawing_data_received(int _t1, int _t2, const QColor & _t3)
{
