/****************************************************************************
** Meta object code from reading C++ file 'pixel_canvas.h'
**
...
#include "../../../src/core/pixel_canvas.h"
...
#error "The header file 'pixel_canvas.h' doesn't include <QObject>."
...
void PixelCanvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->canvas_changed(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (PixelCanvas::*)()>(_a, &PixelCanvas::canvas_changed, 0))
            return;
    }
}
...
// SIGNAL 0
void PixelCanvas::canvas_changed()
{
